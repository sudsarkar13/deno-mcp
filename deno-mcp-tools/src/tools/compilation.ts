 ...
 */
export async function denoCompile(options: DenoCompileOptions): Promise<DenoCommandResult> {
  const {
    script,
    output,
    target,
 ...
 */
export async function denoDoc(options: DenoDocOptions): Promise<DenoCommandResult> {
  const {
    source,
    filter,
    json = false,
 ...
 */
export async function denoInfo(options: DenoInfoOptions): Promise<DenoCommandResult> {
  const {
    module,
    json = false,
    importMap,
 ...
 */
export async function denoTypes(options: {
  output?: string;
